...
export const HowItWorksHouse = () => {
  return <section className="py-20 bg-muted">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 animate-fade-in">
          <h2 id="how-it-works-house" className="text-4xl md:text-5xl font-bold text-foreground mb-4 scroll-mt-16">
        ...
        loop: true
          ...
          <CarouselContent className="ml-0 md:-ml-4">
            {steps.map((step, index) => <CarouselItem key={index} className="pl-0 md:pl-4 md:basis-1/2 lg:basis-1/3">
